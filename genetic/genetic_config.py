...
class GeneticConfigManager:
    ...
    def _load_genetic_config(self) -> GeneticAlgorithmConfig:
        ...
        return GeneticAlgorithmConfig(
            ...
            diversity_penalty_weight=self.config.getfloat("GENETIC", "diversity_penalty_weight", fallback=1.0),
            diversity_penalty_threshold=self.config.getfloat("GENETIC", "diversity_penalty_threshold", fallback=0.3),
            species_distance_threshold=self.config.getfloat("GENETIC", "species_distance_threshold", fallback=0.25),
